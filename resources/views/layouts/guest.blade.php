...
<body x-data="{ scrollFromTop: false }"
  ...
  <header class="relative p-0 m-0">
    ...
    <div class="top-0 z-40 w-full bg-green-800" x-data="{ show: false }"
      ...
      <nav class="top-0 z-50 flex items-center justify-between w-full px-3 py-3 mx-auto font-medium text-black lg:px-6"
        :class="{ 'max-w-7xl': scrollFromTop, '': !scrollFromTop }">
        <a href="/" class="flex items-center">
          <img src="/img/favicon.png" alt="al-ansar university"
            :class="{ 'block': scrollFromTop, 'hidden': !scrollFromTop }"
            class="p-1 rounded-lg h-au to w-14 lg:w-18"><span class="text-white uppercase max-w-min lg:text-lg">Al-Ansar
            University</span>
        </a>
        <div class="hidden lg:block">
          <ul class="flex flex-col space-x-4 text-white lg:flex-row xl:space-x-6">
            ...
            <li class="z-10 p-0 m-0" x-data="{ dropdown: false }" @mouseover="dropdown = true" @click="dropdown = true">
              <a href="/news"
                class="uppercase transition duration-500 hover:text-red-600 hover:opacity-95">News/Events</a>
            </li>
            <li class="p-0 m-0">
        ...
        <div x-cloak class="fixed top-0 bottom-0 right-0 z-50 w-3/5 min-h-screen py-8 text-center bg-green-800"
          x-show="show" x-transition:enter.duration.500ms x-transition:leave.duration.500ms
          ...
          <ul class="flex flex-col pt-8 pl-8 space-y-8 font-semibold text-left text-white h-4/5">
            <li class="p-0 m-0">
              <a class="uppercase transition duration-500 hover:text-red-500 hover:opacity-95" href="/admin">
                Home
              </a>
            </li>
            <li class="p-0 m-0">
      ...
      <div class="max-w-sm space-y-4 text-gray-400">
        ...
        <div class="d-flex">
          ...
          <div class="pl-3">
            ...
            <p>No 24 Ahmadu Gonimi Road, Off Gombole, Old GRA Maiduguri, Borno State.</p>
          </div>
        </div>
        <div class="d-flex">
