    ...
    <div class="w-full mx-auto md:px-2 lg:px-0">
      <div class="w-full bg-cover bg-black  text-white bg-[url('/img/bg.jpeg')] ">
        <div class="w-full flex flex-row py-8 px-10 bg-black bg-opacity-75 md:py-12 lg:py-24">
            ...
            <a class="flex px-3 md: px-6 py-2 md:py-3 font-medium text-center text-green-800 uppercase transition-all duration-300 ease-in-out transform bg-white border-2 border-green-600 rounded-sm hover:opacity-95 hover:bg-white hover:text-green-600 hover:border-green-600 hover:scale-90"
